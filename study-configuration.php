		...
		<form>
			...
			<?php 
				...
				?>
					...
					<dt>Task bar CSS:&nbsp;<span class="hinttext">The CSS file to use for the task tab. Usually:<i>http://staff.washington.edu/rbwatson/wluxTaskBar.css</i></span></dt><dd><input id="taskBarCSS" type="url" style="width:40em" name="taskBarCSS" placeholder=".css url" value=<?php if($defaults){ print trim($defaults['taskBarCSS']); }?> required><dd>
					...
					<dt>Return URL:&nbsp;<span class="hinttext">The URL of the page to return to when then end-task button is clicked. Usually: <i>http://staff.washington.edu/rbwatson/end.php</i></span></dt><dd><input id="returnURL" type="url" style="width:40em" name="returnURL" value=<?php if($defaults){ print trim($defaults['returnURL']); }?> required></dd>
